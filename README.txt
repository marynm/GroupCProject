...
3. On Raspberry Pi 3 run bot.c. Once running the monitor and other hardware must be disconnected (monitor, mouse, and keyboard) so that the bot can move freely.
